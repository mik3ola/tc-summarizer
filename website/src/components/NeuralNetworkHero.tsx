...
function GradientBackground() {
  return (
    <div className="absolute inset-0 -z-10 w-full h-full bg-gradient-to-br from-blue-50 via-white to-purple-50">
...
interface HeroProps {
  ...
  badgeText?: string;
  badgeLabel?: string;
  ctaButtons?: Array<{ text: string; href: string; primary?: boolean; external?: boolean }>;
