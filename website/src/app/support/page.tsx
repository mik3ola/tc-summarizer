        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-5 mb-16 animate-on-scroll">
            ...
            <a
              ...
              className="flex flex-col items-center text-center rounded-2xl border p-6 bg-muted/10 hover:border-green-500/50 transition-all group"
            >
              <div className="w-12 h-12 rounded-xl bg-green-500/15 text-green-400 flex items-center justify-center mb-4">
              ...
              <h3 className="font-semibold text-sm mb-1 group-hover:text-green-400 transition-colors">WhatsApp</h3>
              <p className="text-muted-foreground text-xs">Chat with us directly</p>
              <p className="text-muted-foreground/60 text-xs mt-1">Quick response</p>
            </a>
